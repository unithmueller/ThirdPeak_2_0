...
%Output: 
    ...
    destinationStruc.TrackLength.NetLength.XY(end+1,:) = {xydist(1,1), xydist(1,2), SingleTrackData(:,end)};
    destinationStruc.TrackLength.NetLength.XYZ(end+1,:) = {xyzdist(1,1), xyzdist(1,2), SingleTrackData(:,end)};
end