...
%Output:
    ...
    %save the angles
    destinationStruc.JumpAngles.XY(end+1,:) = {SingleTrackData(1,1), anglesxy, SingleTrackData(:,end)};
    destinationStruc.JumpAngles.XYZ(end+1,:) = {SingleTrackData(1,1), anglesxyz, SingleTrackData(:,end)};
end