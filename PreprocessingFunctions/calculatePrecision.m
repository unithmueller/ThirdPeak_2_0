function [precisionXYString, precisionZString] = calculatePrecision(intensityLocs, lengthUnit)
...
%Sturcture:error in 6 for xy and 7 for z.
    ...
    ylabel("Counts");
    xlabel(strcat("Localisation precision ", "[", lengthUnit, "]"));
    title("Lateral localization precision");
    ...
    ylabel("Counts");
    xlabel(strcat("Localisation precision ", "[", lengthUnit, "]"));
    title("Axial localization precision");
