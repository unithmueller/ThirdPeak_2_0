function [minv, maxv, gaussDat, kernelDat, newBinNmbrs] = plotJumpDistance(Axes, binNumbers, SaveStructure, dimension, isPixel, lengthUnit, filterIDs, performFit, autoBins)
