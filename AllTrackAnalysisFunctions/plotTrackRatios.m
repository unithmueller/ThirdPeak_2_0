function [minv, maxv, gaussDat, kernelDat, newBinNmbrs] = plotTrackRatios(Axes, binNumbers, SaveStructure, property, dimension, isPixel, lengthUnit, filterIDs, performFit, autoBins)
