function [minv, maxv, LinFitDat, newBinNmbrs] = plotCumulativeMeanJumpDistance(Axes, binNumbers, SaveStructure, dimension, isPixel, lengthUnit, filterIDs, performFit, autoBins)
...
%Input: Axes - axes object to plot into
       ...
       if size(filterIDs,1)>0
           ...
           newids = cell(size(filterIDs,1),1);
