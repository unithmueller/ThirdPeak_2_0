function [minv, maxv, gaussDat, kernelDat, newBinNmbrs] = plotMeanJumpDistance(Axes, binNumbers, SaveStructure, dimension, isPixel, lengthUnit, filterIDs, performFit, autoBins)
