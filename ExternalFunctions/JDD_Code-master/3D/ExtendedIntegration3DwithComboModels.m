...
function [prob,value,method]=ExtendedIntegration3DwithComboModels(modelsToTest,dbeta,beta,N,yi,ri,dr,tau)
...
for i = 1:size(modelsToTest,1)
    switch modelsToTest(i)
        ...
        case 4%  done
            ...
            lengthDalpha=maxDalpha-minDalpha;
            x1 = linspace(minDalpha,maxDalpha,100);
            [out]=intfuncConf3d(x1,N,yi,ri,dr,tau);
        ...
        case 5%  done
            ...
            [out]=intfuncDD3d(x1,x2,x3,N,yi,ri,dr,tau);
            prob(i,1) = 5;
        ...
        case 6%  done
            ...
            out=intfuncDV3d(x1,x2,x3,x4,N,yi,ri,dr,tau);
            prob(i,1) = 6;
        ...
        case 7 %done
            ...
            elseif maxalphada>1
                ...
                [out]=intfuncDA3d(x1,x2,x3,x4,N,yi,ri,dr,tau);
        ...
        case 8%  done
            ...
            prob(i,1) = 8;
            [out]=intfuncDConf3d(x1,x2,x3,N,yi,ri,dr,tau);
        ...
        case 9%  done
            ...
            [out]=intfuncDirDir3d(x1,x2,x3,x4,x5,N,yi,ri,dr,tau);
            prob(i,1) = 9;
        ...
        case 10 %done
            ...
            x5 = linspace(minfd,maxfd,12);
            [out]=intfuncVA3D(x2,x1,x4,x3,x5,N,yi,ri,dr,tau);
            prob(i,1) = 10;
        ...
        case 11
            ...
            [out]=intfuncDirConf3d(x1,x2,x3,x4,N,yi,ri,dr,tau);
        ...
        case 12
            ...
            elseif maxalpha1>1 %just upper bound is above.
                ...
                x4 = linspace(minalpha2,maxDalpha2,12);
                x5 = linspace(minfd,maxfd,12);

                [out]=intfuncAnoAno3d(x1,x2,x3,x4, x5, N,yi,ri,dr,tau);
        ...
        case 13
            ...
            elseif maxalphada>1
                ...
                x3 = linspace(minalphada,maxalphada,24); x4 = linspace(minfd,maxfd,24);
                [out]=intfuncAnomConf3d(x1,x2,x3,x4,N,yi,ri,dr,tau);
        ...
        case 14
            ...
            x3 = linspace(minfd,maxfd,50);
            [out]=intfuncConfConf3d(x1,x2,x3,N,yi,ri,dr,tau);
