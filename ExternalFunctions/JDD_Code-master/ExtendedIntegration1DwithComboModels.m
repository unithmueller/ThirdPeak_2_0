...
function [prob,value,method]=ExtendedIntegration1DwithComboModels(modelsToTest,dbeta,beta,N,yi,ri,dr,tau)
...
for i = 1:size(modelsToTest,1)
    switch modelsToTest(i)
        ...
        case 4
            ...
            lengthDalpha=maxDalpha-minDalpha;
            x1 = linspace(minDalpha,maxDalpha,100);
            out=intfuncConf(x1,N,yi,ri,dr,tau);
        ...
        case 8
            ...
            prob(i,1) = 8;
            [out]=intfuncDConf(x1,x2,x3,N,yi,ri,dr,tau);
        ...
        case 9
            ...
            [out]=intfuncDirDir(x1,x2,x3,x4,x5,N,yi,ri,dr,tau);
            prob(i,1) = 9;
        ...
        case 10
            ...
            x5 = linspace(minfd,maxfd,12);
            [out]=intfuncDirAnom(x1,x2,x3,x4,x5,N,yi,ri,dr,tau);
            prob(i,1) = 10;
...
prob(i,1) = 11;
            ...
            [out]=intfuncDirConf(x1,x2,x3,x4,N,yi,ri,dr,tau);
        ...
        case 12
            ...
            elseif maxalpha1>1 %just upper bound is above.
                ...
                lengthalpha2=maxDalpha2-minalpha2;
                lengthfd=maxfd-minfd;
                ...
                [out]=intfuncAnoAno(x1,x2,x3,x4, x5, N,yi,ri,dr,tau);
        ...
        case 13
            ...
            elseif maxalphada>1
                ...
                x3 = linspace(minalphada,maxalphada,24); x4 = linspace(minfd,maxfd,24);
                [out]=intfuncAnomConf(x1,x2,x3,x4,N,yi,ri,dr,tau);
        ...
        case 14
            ...
            x3 = linspace(minfd,maxfd,50);
            [out]=intfuncConfConf(x1,x2,x3,N,yi,ri,dr,tau);
